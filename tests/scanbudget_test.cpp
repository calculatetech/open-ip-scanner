...
int main()
{
    ...
    require(fast.targetDeadlineMs == 1000 && fast.pingAttempts == 1 &&
            fast.pingTimeoutSeconds == 1 && fast.serviceAttempts == 1 &&
            fast.serviceTimeoutMs == 180);
    require(balanced.targetDeadlineMs == 2000 && balanced.pingAttempts == 1 &&
            balanced.pingTimeoutSeconds == 1 && balanced.serviceAttempts == 1 &&
            balanced.serviceTimeoutMs == 280);
    require(high.targetDeadlineMs == 4000 && high.pingAttempts == 2 &&
            high.pingTimeoutSeconds == 1 && high.serviceAttempts == 1 &&
            high.serviceTimeoutMs == 300);
    require(maximum.targetDeadlineMs == 8000 && maximum.pingAttempts == 2 &&
            maximum.pingTimeoutSeconds == 2 && maximum.serviceAttempts == 2 &&
            maximum.serviceTimeoutMs == 600);
    ...
    require(estimatedScanUpperBoundMs(4096, 4, maximum.targetDeadlineMs) == 8499200);
    require(estimatedScanUpperBoundMs(5, 4, balanced.targetDeadlineMs) == 4600);
