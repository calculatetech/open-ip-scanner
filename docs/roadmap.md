...
The current audited release is `0.2.0` at commit `91e0a7a`. Version 1.0 is not ready. Every unchecked item under “Required for 1.0” is a release gate; the post-1.0 section is explicitly outside the first production release.
...
<a id="roadmap-001"></a>
- [ ] **ROADMAP-001 — Freeze scan configuration and ownership before starting workers.** `Blocker`
  ...
  - Disable or safely defer settings that cannot change during a scan. No worker may read a Qt container or ordinary C++ field while the UI thread can mutate the same object.
  - Done when a test changes preferences during an active scan without affecting that scan, the next scan receives the new values, and ThreadSanitizer reports no race in this scenario.

<a id="roadmap-002"></a>
- [ ] **ROADMAP-002 — Make Stop and window close bounded and cancellation-aware.** `High`
...
<a id="roadmap-003"></a>
- [ ] **ROADMAP-003 — Replace the duplicate accuracy pass with a budgeted scan engine.** `High`
...
<a id="roadmap-004"></a>
- [ ] **ROADMAP-004 — Make target and adapter defaults valid by construction.** `High`
...
<a id="roadmap-005"></a>
- [ ] **ROADMAP-005 — Validate neighbor entries before calling a host alive.** `High`
...
<a id="roadmap-006"></a>
- [ ] **ROADMAP-006 — Separate open-port evidence from verified service identity.** `High`
...
<a id="roadmap-007"></a>
- [ ] **ROADMAP-007 — Replace per-row table rebuilding with a scalable result model.** `High`
...
<a id="roadmap-008"></a>
- [ ] **ROADMAP-008 — Implement one asynchronous, interface-scoped Avahi reverse resolver per scan.** `High`
...
<a id="roadmap-009"></a>
- [ ] **ROADMAP-009 — Expose enrichment provenance and Avahi health.** `High`
...
<a id="roadmap-010"></a>
- [ ] **ROADMAP-010 — Add a deterministic mDNS reverse-resolution compatibility suite.** `High`
...
<a id="roadmap-011"></a>
- [ ] **ROADMAP-011 — Fix settings round trips and migrations.** `High`
...
<a id="roadmap-012"></a>
- [ ] **ROADMAP-012 — Make CSV export safe and failure-aware.** `High`
...
<a id="roadmap-013"></a>
- [ ] **ROADMAP-013 — Define target-history privacy and safe-scan behavior.** `Medium`
...
<a id="roadmap-014"></a>
- [ ] **ROADMAP-014 — Split the 3,534-line window into testable layers.** `Medium`
...
<a id="roadmap-015"></a>
- [ ] **ROADMAP-015 — Establish the automated 1.0 quality gate.** `Blocker`
  - Aggregate the feature-owned CTest suites specified by items such as ROADMAP-010, ROADMAP-011, and ROADMAP-012, then add the remaining integration, GUI, cancellation, stress, and package coverage. Add CI for the oldest and newest supported compiler/Qt combinations.
...
<a id="roadmap-016"></a>
- [ ] **ROADMAP-016 — Declare and enforce a truthful 1.0 platform matrix.** `High`
...
<a id="roadmap-017"></a>
- [ ] **ROADMAP-017 — Add actionable diagnostics without collecting user data.** `High`
...
<a id="roadmap-018"></a>
- [ ] **ROADMAP-018 — Curate, license, and update the vendor database reproducibly.** `High`
...
<a id="roadmap-019"></a>
- [ ] **ROADMAP-019 — Make the Debian package policy-clean and license-complete.** `Blocker`
...
<a id="roadmap-020"></a>
- [ ] **ROADMAP-020 — Bring AppStream and desktop metadata to release quality.** `High`
...
<a id="roadmap-021"></a>
- [ ] **ROADMAP-021 — Apply release hardening and artifact provenance.** `High`
...
<a id="roadmap-022"></a>
- [ ] **ROADMAP-022 — Make install and uninstall prefix-safe.** `High`
...
<a id="roadmap-023"></a>
- [ ] **ROADMAP-023 — Fix startup warnings, accessibility, and theme behavior.** `Medium`
...
<a id="roadmap-024"></a>
- [ ] **ROADMAP-024 — Complete the 1.0 release documentation and support contract.** `Medium`
...
<a id="roadmap-025"></a>
- [ ] **ROADMAP-025 — Add end-to-end IPv6 scanning and enrichment.**
...
<a id="roadmap-026"></a>
- [ ] **ROADMAP-026 — Add tested non-Linux discovery backends if cross-platform support is desired.**
...
<a id="roadmap-027"></a>
- [ ] **ROADMAP-027 — Add additional distribution formats only after the Debian release is repeatable.**
...
<a id="roadmap-028"></a>
- [ ] **ROADMAP-028 — Add localization after strings and layouts are designed for translation.**
...
<a id="roadmap-029"></a>
- [ ] **ROADMAP-029 — Add DNS-SD device and advertised-service discovery if product scope requires it.**
  ...
  - Add AAAA and link-local IPv6 records only together with ROADMAP-025. Cover service-instance identity, record lifetime, duplicate advertisements, allowed TXT fields, cancellation, and controlled `_http._tcp`, `_ssh._tcp`, and `_ipp._tcp` fixtures before claiming DNS-SD enrichment.

## Completed

No production-readiness roadmap item was complete at the audited `0.2.0` baseline. Move an item here only with links to the validating tests, release artifact, or documentation evidence; do not delete its identifier.
